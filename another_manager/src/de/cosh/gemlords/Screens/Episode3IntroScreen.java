 ...
 */
public class Episode3IntroScreen implements Screen {
    ...
    public void show() {
        ...
        continueButton.addListener(new ClickListener() {
            public void clicked(InputEvent event, float x, float y) {
                GemLord.getInstance().player.watchedEpisode3Intro();
                GemLord.getInstance().player.savePreferences();
                GemLord.getInstance().setScreen(GemLord.getInstance().episode3TraverseScreen);
            }
        });
        ...
        Label label1 = new Label("You did it again! ", s);
        Label label2 = new Label("I am pleased with you", s);
        Label label3 = new Label("Now, go home, don't come ", s);
        Label label4 = new Label("any closer. Thank you.", s);
        Label label5 = new Label("", s);
        Label label6 = new Label("Your Dark Lord.", s);
