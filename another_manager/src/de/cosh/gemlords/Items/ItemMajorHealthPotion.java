 ...
 */
public class ItemMajorHealthPotion extends BaseItem implements UseItem {
	private int cooldown;
	private Integer currentCooldown;
    private Random random;

	public ItemMajorHealthPotion() {
		super("majorhealthpotion");
        LanguageManager lm = LanguageManager.getInstance();
		itemNumber = 18;
		setItemName(lm.getString("Major potion"));
		setItemText(lm.getString("Recover 20-40 hp\nCooldown: 10"));
	...
	public void onUse() {
		...
		if (currentCooldown <= 0) {
            ...
            int healthRegenned = random.nextInt((40 - 20)+1);
            healthRegenned += 20;
