...
public class CustomStyle {
    ...
    private void createStyles() {
        ...
        buttonUp = new TextureRegionDrawable(new TextureRegion(GemLord.assets.get("data/textures/pack.atlas", TextureAtlas.class).findRegion("buttonup")));
        buttonDown = new TextureRegionDrawable(new TextureRegion(GemLord.assets.get("data/textures/pack.atlas", TextureAtlas.class).findRegion("buttondown")));
